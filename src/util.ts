...
export function createOperator<Resolve, In, Out> (fn: CallFn<In, Out>, thisArg: any, exec: (previous: In | undefined, finish: Finish<Resolve>) => void): Operator<Resolve, In, Out> {
  return (previous) => ({
